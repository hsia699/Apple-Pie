...
#CSV data source
airfare_data = pd.read_csv('/Users/hsia/Desktop/spring2024/90819/90819_Project/Airfare Data.csv', sep = ',')
                ...
                while True:
                    ...
                    if origin_city not in (airfare_data['City Name'].values):
                        ...
                        while True: 
                            ...
                            #Use chained comparison to restrict user input for years to range our program has data for
